...
public class CustomElasticQueryFieldTypeProvider : ISchemaBuilder
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ILogger _logger;

    public CustomElasticQueryFieldTypeProvider(IHttpContextAccessor httpContextAccessor, ILogger<CustomElasticQueryFieldTypeProvider> logger)
    {
    ...
    public async Task BuildAsync(ISchema schema)
    {
        ...
        var queries = await queryManager.ListQueriesBySourceAsync(CustomElasticQuerySource.SourceName);
